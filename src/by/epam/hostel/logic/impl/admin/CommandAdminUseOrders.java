...
/**
 * This class implements a pattern command. This class shows all the orders of
 * users.
 * 
 * @author Alex Nastin
 */
public class CommandAdminUseOrders implements ICommand {
	/**
	 * This method shows all the orders of users.
	 * 
	 * @param request
